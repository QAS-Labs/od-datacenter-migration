...
alter table public.custom_field_integration_values add column if not exists fromid int8 null, add column if not exists fromclientid int8 null;
alter table public.custom_field_integration_values_aud add column if not exists fromid int8 null, add column if not exists fromclientid int8 null;
alter table public.integration_custom_field_configurations add column if not exists fromid int8 null, add column if not exists fromclientid int8 null;
alter table public.integration_custom_field_configurations_aud add column if not exists fromid int8 null, add column if not exists fromclientid int8 null;
alter table public.integration_custom_field_data_types add column if not exists fromid int8 null, add column if not exists fromclientid int8 null;
alter table public.integration_custom_fields add column if not exists fromid int8 null, add column if not exists fromclientid int8 null;
alter table public.integration_custom_fields_aud add column if not exists fromid int8 null, add column if not exists fromclientid int8 null;
