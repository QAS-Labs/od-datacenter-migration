...
set externalurl = replace(a.externalurl,
                            concat('https://cambridgeasmt.qtestnet.com/p/',p.fromid,'/portal/project#tab='),
                            concat('https://cambridgeasmt.qtestnet.com/p/',p.id,'/portal/project#tab=')
)
from ztmpclientmigration.newid_projects p
where a.clientid IN (:clientid)
and a.fromclientid IN (:clientid)
and a.clientid = p.clientid
and a.externalurl ilike concat('https://cambridgeasmt.qtestnet.com/p/',p.fromid,'/portal/project#tab=','%')
;