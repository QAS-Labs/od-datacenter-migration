...
set externalurl = replace(a.externalurl,
                            concat('https://specsavers.qtestnet.com/p/',p.fromid,'/portal/project#tab='),
                            concat('https://specsavers.qtestnet.com/p/',p.id,'/portal/project#tab=')
)
from ztmpclientmigration.newid_projects p
where a.clientid IN (:clientid)
and a.fromclientid IN (:clientid)
and a.clientid = p.clientid
and a.externalurl ilike concat('https://specsavers.qtestnet.com/p/',p.fromid,'/portal/project#tab=','%')
;