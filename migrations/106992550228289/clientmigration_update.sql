...
\copy (SELECT clientid as fromclientid, sessionid, fromid FROM session WHERE clientid IN (10699,25502,28289) and fromid is not null and sessionid != fromid) to 'newid_session.dat'
...
where a.objectid = z.fromid
and a.clientid IN (10699,25502,28289)
