...
integration_identifier_fields,integration_external_defect_issue_data,integration_defect_issue_data,integration_projects,integration_type_maps,integration_requirement_field_maps,integration_release_configuration,integration_issue_release_maps,integration_release_data,integration_external_issues,integration_issue_test_case_maps,integration_issue_requirement_maps,integration_external_issues_maps,integration_webhooks,configuration_migration_tracking,integration_sync_requirement_tracker,integration_issue_test_case_run_maps,integration_defect_fields,integration_module_fields,integration_defect_field_maps,
custom_field_data_types,custom_fields,custom_field_validators,custom_field_values,custom_field_template,custom_field_template_field_mapping,
integration_custom_field_data_types,integration_custom_fields,integration_custom_field_configurations,custom_field_configurations,custom_field_integration_values,
integration_issue_data,
...
and (d.fromid is null or d.fromid is not null and d.fromid != d.id);
insert into public.automation_cancelled_executions (id,scheduleid,agentid,cancelleddate,objecttype,objectid,projectid,clientid,fromid,fromclientid) 
select s.id,s.scheduleid,s.agentid,s.cancelleddate,s.objecttype,s.objectid,s.projectid,s.clientid,s.id,s.fromclientid from ztmpclientmigration.automation_cancelled_executions s 
...
insert into public.automation_cancelled_executions (fromid,scheduleid,agentid,cancelleddate,objecttype,objectid,projectid,clientid,fromclientid)
select s.id,s.scheduleid,s.agentid,s.cancelleddate,s.objecttype,s.objectid,s.projectid,s.clientid,s.fromclientid from ztmpclientmigration.automation_cancelled_executions s 
...
create index idx_tmp_blob_handles_fromid_id on blob_handles(fromid, id) where clientid in (10699,25502,28289);
...
where t.clientid in (10699,25502,28289);
drop index idx_tmp_blob_handles_fromid_id;
create index idx_tmp_object_assignments_fromid_id on object_assignments(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_custom_fields_fromid_id on custom_fields(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_requirements_fromid_id on requirements(fromid, id) where clientid in (10699,25502,28289);
...
where t.clientid in (10699,25502,28289);
create index idx_tmp_test_cases_fromid_id on test_cases(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_test_case_run_fromid_id on test_case_run(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_test_case_versions_fromid_id on test_case_versions(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_test_steps_fromid_id on test_steps(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_test_case_results_fromid_id on test_case_results(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_test_step_results_fromid_id on test_step_results(fromid, id) where clientid in (10699,25502,28289);
...
create index idx_tmp_defects_fromid_id on defects(fromid, id) where clientid in (10699,25502,28289);
