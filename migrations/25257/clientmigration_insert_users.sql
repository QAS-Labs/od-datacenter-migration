...
and (d.fromid is null or d.fromid is not null and d.fromid != d.id);
insert into public.automation_schedules (id,repeattype,enddate,startdate,creatorid,name,deleted,agentid,repeatperiod,fromid,fromclientid) 
select s.id,s.repeattype,s.enddate,s.startdate,s.creatorid,s.name,s.deleted,s.agentid,s.repeatperiod,s.id,s.fromclientid from ztmpclientmigration.automation_schedules s 
...
insert into public.automation_schedules (fromid,repeattype,enddate,startdate,creatorid,name,deleted,agentid,repeatperiod,fromclientid) 
select s.id,s.repeattype,s.enddate,s.startdate,s.creatorid,s.name,s.deleted,s.agentid,s.repeatperiod,s.fromclientid from ztmpclientmigration.automation_schedules s 
...
and (d.fromid is null or d.fromid is not null and d.fromid != d.id);
insert into public.automation_schedule_execution_maps (id,scheduleid,objecttype,objectid,deleted,fromid,fromclientid)
select s.id,s.scheduleid,s.objecttype,s.objectid,s.deleted,s.id,s.fromclientid from ztmpclientmigration.automation_schedule_execution_maps s 
...
insert into public.automation_schedule_execution_maps (fromid,scheduleid,objecttype,objectid,deleted,fromclientid)
select s.id,s.scheduleid,s.objecttype,s.objectid,s.deleted,s.fromclientid from ztmpclientmigration.automation_schedule_execution_maps s 
inner join public.automation_schedule_execution_maps d on s.id = d.id
and (d.fromid is null or d.fromid is not null and d.fromid != d.id);
insert into public.automation_execution_results (id,testrunids,scheduleid,agentid,status,enddate,startdate,consolelogblobhandleid,name,executionstartdate,executionenddate,agentlogblobhandleid,fromid,fromclientid) 
select s.id,s.testrunids,s.scheduleid,s.agentid,s.status,s.enddate,s.startdate,s.consolelogblobhandleid,s.name,s.executionstartdate,s.executionenddate,s.agentlogblobhandleid,s.id,s.fromclientid from ztmpclientmigration.automation_execution_results s
...
insert into public.automation_execution_results (fromid,testrunids,scheduleid,agentid,status,enddate,startdate,consolelogblobhandleid,name,executionstartdate,executionenddate,agentlogblobhandleid,fromclientid) 
select s.id,s.testrunids,s.scheduleid,s.agentid,s.status,s.enddate,s.startdate,s.consolelogblobhandleid,s.name,s.executionstartdate,s.executionenddate,s.agentlogblobhandleid,s.fromclientid from ztmpclientmigration.automation_execution_results s 
...
and (d.fromid is null or d.fromid is not null and d.fromid != d.id);
insert into public.integration_issue_data (id,integrationissuerequirementmapid,externalissuefieldvalue,externalissuefieldid,fromid,fromclientid)
select s.id,s.integrationissuerequirementmapid,s.externalissuefieldvalue,s.externalissuefieldid,s.id,s.fromclientid from ztmpclientmigration.integration_issue_data s
...
insert into public.integration_issue_data (fromid,integrationissuerequirementmapid,externalissuefieldvalue,externalissuefieldid,fromclientid)
select s.id,s.integrationissuerequirementmapid,s.externalissuefieldvalue,s.externalissuefieldid,s.fromclientid from ztmpclientmigration.integration_issue_data s
...
and (d.fromid is null or d.fromid is not null and d.fromid != d.id);
insert into public.custom_field_configurations (id,sitefieldconfigurationid,valueid,value,attribute,customfieldid,fromid,fromclientid)
select s.id,s.sitefieldconfigurationid,s.valueid,s.value,s.attribute,s.customfieldid,s.id,s.fromclientid from ztmpclientmigration.custom_field_configurations s
...
insert into public.custom_field_configurations (fromid,sitefieldconfigurationid,valueid,value,attribute,customfieldid,fromclientid)
select s.id,s.sitefieldconfigurationid,s.valueid,s.value,s.attribute,s.customfieldid,s.fromclientid from ztmpclientmigration.custom_field_configurations s
...
insert into public.custom_field_configurations_aud (id,rev,trxcreateddate,trxcreateduserid,sitefieldconfigurationid,valueid,value,attribute,customfieldid,projectid,clientid,createddate,createduserid,revtype,fromid,fromclientid)
select t.id,s.rev,s.trxcreateddate,s.trxcreateduserid,s.sitefieldconfigurationid,s.valueid,s.value,s.attribute,s.customfieldid,s.projectid,s.clientid,s.createddate,s.createduserid,s.revtype,s.id,s.fromclientid from ztmpclientmigration.custom_field_configurations_aud s
...
create index idx_tmp_blob_handles_fromid_id on blob_handles(fromid, id) where clientid in (25257);
...
where t.clientid in (25257);
drop index idx_tmp_blob_handles_fromid_id;
create index idx_tmp_object_assignments_fromid_id on object_assignments(fromid, id) where clientid in (25257);
...
create index idx_tmp_custom_fields_fromid_id on custom_fields(fromid, id) where clientid in (25257);
...
create index idx_tmp_requirements_fromid_id on requirements(fromid, id) where clientid in (25257);
...
where t.clientid in (25257);
create index idx_tmp_test_cases_fromid_id on test_cases(fromid, id) where clientid in (25257);
...
create index idx_tmp_test_case_run_fromid_id on test_case_run(fromid, id) where clientid in (25257);
...
create index idx_tmp_test_case_versions_fromid_id on test_case_versions(fromid, id) where clientid in (25257);
...
create index idx_tmp_test_steps_fromid_id on test_steps(fromid, id) where clientid in (25257);
...
create index idx_tmp_test_case_results_fromid_id on test_case_results(fromid, id) where clientid in (25257);
...
create index idx_tmp_test_step_results_fromid_id on test_step_results(fromid, id) where clientid in (25257);
...
create index idx_tmp_defects_fromid_id on defects(fromid, id) where clientid in (25257);
