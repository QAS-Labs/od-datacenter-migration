...
\copy (SELECT clientid, id, fromid FROM projects WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_projects.dat'
\copy (SELECT clientid, id, fromid FROM test_cases WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_test_cases.dat'
\copy (SELECT clientid, id, fromid FROM requirements WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_requirements.dat'
\copy (SELECT clientid, id, fromid FROM defects WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_defects.dat'
\copy (SELECT clientid, id, fromid FROM test_steps WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_test_steps.dat'
\copy (SELECT clientid, id, fromid FROM builds WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_builds.dat'
\copy (SELECT clientid, id, fromid FROM releases WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_releases.dat'
\copy (SELECT clientid, id, fromid FROM test_case_run WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_test_case_run.dat'
\copy (SELECT clientid, id, fromid FROM test_case_results WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_test_case_results.dat'
\copy (SELECT clientid, id, fromid FROM test_suites WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_test_suites.dat'
\copy (SELECT clientid, id, fromid FROM data_queries WHERE clientid in (18555,25369,25749) and fromid is not null and id != fromid) to 'newid_data_queries.dat'
*/
